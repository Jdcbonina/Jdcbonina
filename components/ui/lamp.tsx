    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic dark:from-cyan-500 dark:from-white-500 dark:via-transparent dark:to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic dark:from-transparent dark:via-transparent dark:to-cyan-500 to-white-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
